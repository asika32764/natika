	...
	public function define(Form $form)
	{
		...
		$form->wrap(null, 'search', function (Form $form)
		{
			...
			$form->add('field', new ListField)
				...
				->addOption(new Option(Translator::translate('admin.user.field.title'), 'user.title'))
				->addOption(new Option(Translator::translate('admin.user.field.alias'), 'user.alias'));
